                                        ...
                                        <div style={{ backgroundImage: "url('img/bg7.jpg')" }} className="panel-body bg-cover clearfix">
                                            <div className="media mt0">
                                                <div className="media-left">
                                                    <img src={UtilService.getProfileFromPath(this.state.user.image)} alt="Image" className="media-object img-thumbnail img-circle thumb64" />
                                                </div>
                                        ...
                                        <div className="panel-body">
                                            <form id="editForm" className="form" data-parsley-validate="">
                                                ...
                                                <fieldset>
                                                    <div className="form-group">
                                                        <label>Verify </label>
                                                        {this.state.user.is_verify ? <div className="badge p-sm bg-success pull-right">Verified</div> : <div className="badge p-sm bg-danger pull-right">No</div>}
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div className="form-group">
